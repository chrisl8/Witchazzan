...
1. If you aren't using HTTPS it won't work, which is common when testing. There is a caveat for "localhost",
but not for just using a private IP on your home network, which I do when testing.
