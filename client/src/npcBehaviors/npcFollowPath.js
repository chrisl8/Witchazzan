...
function npcFollowPath({ hadron, clientSprite, newHadronData, hadronUpdated }) {
  ...
  if (nextWaypoint) {
    ...
    if (
      ...
      // NOTE: If your velocity causes the sprites ot overshoot the destination, they
      ...
      if (isRotating) {
        // TODO: This should check to see if we are "past" the target, and only stop if so.
        //       If we are not "past" the target, we should keep moving while rotating.
