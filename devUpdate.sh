...
printf "It is the same as running 'node server.js', except that it will auto restart when you update you\nr code."
printf "\n"
printf "\n"
printf "${BRIGHT_WHITE}------------------${NC}\n"
printf "In the second run:\n"
printf "${LIGHTCYAN}cd ${SCRIPT_DIR}/client${NC}\n"
printf "${LIGHTCYAN}npm run start${NC}\n"
printf "\n"
printf "This will build the client as well as rebuild and cause a browser refresh when file changes ar\ne made."
printf "It should also automatically open your web browser to the page.\n"
printf "If not, go to http://localhost:3001\n"
